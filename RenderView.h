...
{
	LeafIndex_t	leafIndex;		int16	waterData;
	uint16 	firstTranslucentSurface;		uint16	translucentSurfaceCount;
};
...
{
	Vector		m_vecVisOrigin;						float		m_fDistToAreaPortalTolerance;
};
